const SESSION_PLAN_SYSTEM_PROMPT_APPEND = [
  ...
  'After generating a Plan, wait inside the `generate_plan` call until Research Agent returns the user response. Do not report the Plan separately or execute any Plan step while waiting.',
